CREATE TABLE [Person].[Person] (
    ...
    CONSTRAINT [FK_Password_Person_BusinessEntityID] FOREIGN KEY ([BusinessEntityID]) REFERENCES [Person].[Person] ([BusinessEntityID]) NOT FOR REPLICATION
);


GO
ALTER TABLE [Person].[Person] NOCHECK CONSTRAINT [FK_Password_Person_BusinessEntityID];
